...
def generate_random_equiaffine_transform_2d(max_scale=3, min_eig_value_ratio=1.5, max_eig_value_ratio=8):
    while True:
...
def generate_random_affine_transform_2d(max_scale=3, min_eig_value_ratio=1.5, max_eig_value_ratio=8):
    while True:
