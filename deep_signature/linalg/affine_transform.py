...
def generate_random_equiaffine_transform_2d(max_scale=1, min_eig_value_ratio=1, max_eig_value_ratio=1.3):
    while True:
...
def generate_random_affine_transform_2d(max_scale=1, min_eig_value_ratio=1, max_eig_value_ratio=1.3):
    while True:
