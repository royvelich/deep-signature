...
curvature_default_learning_rate = 0.0001
...
arclength_default_train_buffer_size = 1000000
arclength_default_validation_buffer_size = 200000
arclength_default_train_batch_size = int(arclength_default_train_buffer_size / 2)
arclength_default_validation_batch_size = int(arclength_default_validation_buffer_size / 2)
...
arclength_default_num_workers_validation = 10
