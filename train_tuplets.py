...
import numpy
import os
from deep_signature.training import DeepSignatureTupletsDataset
from deep_signature.training import DeepSignatureNet
from deep_signature.training import TupletLoss
...
if __name__ == '__main__':
    ...
    dataset.load_dataset(tuplets_dir_path='C:/deep-signature-data/circles/tuplets/train')
